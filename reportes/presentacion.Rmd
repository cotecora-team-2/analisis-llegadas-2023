...
* Necesitamos un procedimiento para generar muestras parciales con patrones aproximados a los que se ven en días electorales. Por lo tanto, modelamos el tiempo de llegada de las casillas a la base de datos.
...
Supondremos que el tiempo de llegada de las casillas de los 10 municipios de Coahuila con horario estacional es 1 hora anterior al que simulamos con el modelo de tiempos de llegadas.
