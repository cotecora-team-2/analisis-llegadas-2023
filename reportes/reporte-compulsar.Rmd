...
1. Bajo censura, los métodos tienen caídas en su cobertura real vs. la nominal. El tamaño de la caída es diferente para cada método. 

2. Bajo censura, utilizando la unión de los cuatro métodos podemos alcanzar cobertura
...
4. Con muestra completa, los tres métodos probados 
se desempeñan favorablemente en términos de cobertura y la precisón al estimar candidatos es similar.

5. La precisión del intervalo de participación varía por método. 
...
* Media de las precisiones de los intervalos de participación
